...
describe("organizationService", () => {
    ...
    beforeEach(() => {
        ...
        service = (0, organizationService_1.createOrganizationService)(OrganizationModel, UserOrganizationModel, ElectionModel);
        jest.clearAllMocks();
    });
    describe("createOrganization", () => {
        it("creates an organization and assigns user to it", async () => {
            ...
            OrganizationModel.create.mockResolvedValue(mockOrg);
            UserOrganizationModel.create.mockResolvedValue({});
            ...
            expect(OrganizationModel.create).toHaveBeenCalledWith({ name: "Test Org", description: "Test description" }, { transaction: {} });
    ...
    describe("getAllOrganizations", () => {
        it("returns all organizations", async () => {
            ...
            OrganizationModel.findAll.mockResolvedValue(orgs);
    ...
    describe("getOrganizationById", () => {
        it("returns organization if found", async () => {
            ...
            OrganizationModel.findByPk.mockResolvedValue(org);
    ...
    describe("updateOrganization", () => {
        it("updates and returns updated organization", async () => {
            ...
            expect(OrganizationModel.update).toHaveBeenCalledWith({ name: "Updated Org" }, { where: { organization_id: "123" }, returning: true });
            expect(result).toEqual({ organization_id: "123", name: "Updated Org" });
        });
        it("returns null if no organization updated", async () => {
            OrganizationModel.update.mockResolvedValue([0, []]);
    ...
    describe("deleteOrganization", () => {
        it("deletes elections, user orgs, and organization", async () => {
            ElectionModel.destroy.mockResolvedValue(1);
            UserOrganizationModel.destroy.mockResolvedValue(1);
            OrganizationModel.destroy.mockResolvedValue(1);
        ...
        it("returns false if organization not deleted", async () => {
            ElectionModel.destroy.mockResolvedValue(0);
            UserOrganizationModel.destroy.mockResolvedValue(0);
            OrganizationModel.destroy.mockResolvedValue(0);
