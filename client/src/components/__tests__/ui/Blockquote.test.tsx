...
describe("Blockquote Component", () => {
  ...
  it("sets aria-label when provided", () => {
    render(<Blockquote aria-label="Quote label">Accessible quote</Blockquote>);
  ...
  it("sets aria-labelledby when provided", () => {
    render(<Blockquote aria-labelledby="label-id">Labelled quote</Blockquote>);
  ...
  it("sets aria-describedby when provided", () => {
    render(<Blockquote aria-describedby="desc-id">Described quote</Blockquote>);
