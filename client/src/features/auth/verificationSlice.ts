...
export const { setUserJustVerified, resetUserJustVerified } =
  verificationSlice.actions;

export const selectUserJustVerified = (
  state: Pick<RootState, "verificationStatus">,
) => state.verificationStatus.userJustVerified;
