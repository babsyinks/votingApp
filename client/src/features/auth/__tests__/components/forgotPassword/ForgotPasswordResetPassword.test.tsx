    ...
    ({
      ...
      <div data-testid="forgot-password-common-form">
        ...
        <div data-testid="form-props">
          Path: {path}, ResetCode: {data.resetCode}, Password: {data.password},
  ...
  it("renders ForgotPasswordCommonForm with correct props and AuthFieldPassword inputs", () => {
    render(
      <ForgotPasswordResetPassword
        setBottomSpacingClass={mockSetBottomSpacingClass}
      />,
    );
    expect(
      screen.getByTestId("forgot-password-common-form"),
    ).toBeInTheDocument();
    expect(screen.getByTestId("password-input")).toBeInTheDocument();
    expect(screen.getByTestId("password-dup-input")).toBeInTheDocument();
    expect(screen.getByTestId("form-props")).toHaveTextContent(
      "Path: /reset-password",
    );
    expect(screen.getByTestId("form-props")).toHaveTextContent(
      "ResetCode: abc123",
