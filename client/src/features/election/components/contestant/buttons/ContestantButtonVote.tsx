...
export interface ContestantButtonVoteProps {
  /* The id of the contestant who this vote button appears under. */
  contestantId: string;
  /* The position this contestant is vying for, e.g president. */
  position: string;
}
 ...
 */
const ContestantButtonVote = ({
  contestantId,
  position,
}: ContestantButtonVoteProps): JSX.Element => {
