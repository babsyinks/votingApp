...
const ElectivePositionDetailsSummaryPart: React.FC<
  ElectivePositionDetailsSummaryPartProps
> = ({ label, value }) => {
  const headingType: "h2" | "h3" = label === "Position" ? "h2" : "h3";

  return (
    <Block className="z-30 bg-black w-full">
      <Heading className="ff-patrick mx-0-my-7p ta-center" type={headingType}>
