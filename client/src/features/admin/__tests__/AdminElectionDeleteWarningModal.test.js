...
import AdminElectionDeleteWarningModal from '../components/AdminElectionDeleteWarningModal';
...
jest.mock('components/modal/Modal', () => ({
  ...
  <div data-testid="modal">
    <p>{message}</p>
    <button onClick={positiveHandler} data-testid="yes-btn">{positiveBtnTxt}</button>
    <button onClick={negativeHandler} data-testid="no-btn">{negativeBtnTxt}</button>
  </div>
));
